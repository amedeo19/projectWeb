...
$_SESSION["lastPage"] = 'notifiche_fornitore.php';
$fornitore = 2;
...
$query_sql="SELECT * FROM fornitore WHERE fornitore.e_mail_fornitore = '" . $e_mail . "'";
$result = $conn->query($query_sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    $myCliente = new Fornitore($row["name"],$row["categoria"],$row["e_mail_fornitore"],$row["password"],$row["citta"],$row["indirizzo"],$row["desc1"],$row["desc2"],$row["img1"],$row["img2"],$row["img3"]);
  }
}
    ...
    <main class="py-3 text-white bg-secondary">
      ...
      <div class="card h-100">
        ...
        <div class="card-body text-center vcenter" style="padding-bottom:10px;">
            ...
            <form style="float:right;margin:5px;" action="notifiche_fornitore.php" method="post" >
