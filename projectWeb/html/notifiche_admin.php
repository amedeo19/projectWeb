...
$_SESSION["lastPage"] = 'notifiche_admin.php';
$admin = 3;
$_SESSION["num"] = $admin;
$myArray = array();
...
$query_sql="SELECT * FROM admin WHERE admin.e_mail_admin = '" . $e_mail . "'";
$result = $conn->query($query_sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    $myCliente = new Admin($row["username"],$row["e_mail_admin"],$row["password"]);
  }
}

$query_sql1="SELECT * FROM notifica WHERE notifica.destinatario = '" . $admin . "'";
...
<html lang="it-IT">
    ...
    <main class="py-3 text-white bg-secondary">
      ...
      <div class="card h-100">
        ...
        <div class="card-body text-center vcenter" style="padding-bottom:10px;">
            ...
            <form style="float:right;margin:5px;" action="notifiche_admin.php" method="post" >
  ...
  function notify(){
    $.toast({
      text : 'Si è iscritto un nuovo utente',
    ...
    // bootoast.toast({
    //   message: 'Si è iscritto un nuovo utente',
    //   type: 'success'
    // });
  }
