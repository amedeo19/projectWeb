...
$_SESSION["lastPage"] = 'Admin_lista_fornitori.php';
$admin = 3;
$_SESSION["num"] = $admin;
...
if ($login) {
  ...
  if(isset($_POST['delete'])) {
    $e_mail_f = $_POST['delete'];
    deleteFornitore($e_mail_f);
  }
...
function deleteFornitore($e_mail_f){
  $conn = connectToDatabase();
  $query_sql = "DELETE FROM fornitore WHERE fornitore.e_mail_fornitore='" . $e_mail_f . "'";
  $result = $conn->query($query_sql);
}
...
<!--              <div class="card-body justify-content-between">
          ...
          <div style="padding-bottom:10px;padding-top:15px;">
            <form action="Nuovo_fornitore.php">
                  <input type="submit" class="btn btn-primary" value="nuovo fornitore" name="new">
            </form>
          </div>
          ...
          <div class="row" style="padding-bottom:30px;">
            ...
            <?php foreach ($myArray as $key => $value) { ?>
              ...
              <div class="card h-100 " >
                ...
                <div class="card-footer text-center row justify-content-md-center" style="position:center;padding-bottom:10px;">
                  <form style="margin:5px;" action="Admin_lista_fornitori.php" method="post" >
                    <input type="hidden" name="delete" value="<?php echo $value->e_mail_fornitore ?>" />
                        <input type="submit" class="btn btn-primary" value="delete">
                  </form>

                  <form style="margin:5px;" action="Modifica_fornitore.php" method="post" >
      ...
      <div>
        <form action="Admin_lista_fornitori.php" method="post" style="padding-bottom:10px;text-align:right;">
